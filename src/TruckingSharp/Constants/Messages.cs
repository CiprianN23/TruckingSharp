namespace TruckingSharp.Constants
{
    public static class Messages
    {
        ...
        public const string InvalidPasswordInputed = "You inputed an invalid password. Try again.";
        public const string InvalidPasswordLenght = "Invalid password lenght. Password must be between {0} and {1} characters.";
        ...
        public const string TargetIsNotMued = "That player is not muted.";
